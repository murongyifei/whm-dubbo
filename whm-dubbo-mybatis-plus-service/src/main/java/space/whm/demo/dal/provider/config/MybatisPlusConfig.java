package space.whm.demo.dal.provider.config;
 ...
 */
@Configuration
@MapperScan("space.whm.demo.dal.provider.mapper")
public class MybatisPlusConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource, GlobalConfig globalConfig) throws Exception {
        ...
        /* 枚举扫描 */
        sqlSessionFactory.setTypeEnumsPackage("space.whm.demo.dal.provider.enums");
        /* xml扫描 */
